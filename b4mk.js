  ...
  if(hacker == "3"){
	...
	var encrypted_password = MD5(plain_password)
	 ...
	 if(hacker == "3"){
       ...
       else if(form.kku.value == "admin" && encrypted_password == "f743e7c30a6fa4072ae0c226302df90f" && boxCheck.checked == true){
	...
	else if(form.kku.value == "admin" && encrypted_password == "f743e7c30a6fa4072ae0c226302df90f"){
    window.location.href="admin.html"
